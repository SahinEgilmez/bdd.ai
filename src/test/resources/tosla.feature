...
Feature: AI Examples
  ...
  Scenario: Bakiye Metni
    ...
    When I will see img:toolbar title
    ...
    Then I will click img:toolbar arrow
  ...
  Scenario: 1A akbank
    ...
    When I will click img:search field
    ...
    When I will click "Takip Et"
    Then I will wait 2 seconds

    When I will see "Henüz hiçbir toslama yok."
    Then I will wait 2 seconds

    When I will click ai:arrow left
    Then I will wait 2 seconds
